...
This week I attended the **[NLP Summit Healthcare](https://www.nlpsummit.org/)** 2023, a free virual event organized by the [John Snow Labs](https://www.johnsnowlabs.com/). It was a great event with a lot of interesting talks. I'll share some of my key takeaways.
...
Presented in the opening keynote by Dr. David Gondek, Chief Data Scientist at [John Snow Labs](https://www.johnsnowlabs.com/), he sumarized some best practices that i found interesting as I'm beginning my NLP journey:
...
3. **Test beyond accuracy** - Test for Rubustness, Bias, Fairness, Toxicity, Efficiency, Safety. John Snow Labs developed [NLP test](https://nlptest.org/) to help with model testing beyond regular benchmarks.

## 2. Mitigating bias in healthcare language models

**Gaurav Kaushik** from [ScienceIO](https://www.science.io/) presented a talk about mitigating bias in healthcare language models and the importance of it's evaluation.
Performance benchmarks lack the statistical power, they aren't well validated enought and don't disencentivize the use of biased systems.
...
[EHR-Safe: Generating high-fidelity and privacy-preserving synthetic electronic health records](https://ai.googleblog.com/2022/12/ehr-safe-generating-high-fidelity-and.html)
...
- [ProtoPatient Demo](https://protopatient.demo.datexis.com/) - diagnsotic predictions using clinical text and prototypical patients.
...
There were many more interesting sessions, visit [https://www.nlpsummit.org/](https://www.nlpsummit.org/) if you want further information.
